...
case 1:
	    ...
	    return [{tabla: symbolsTable, programa: $$[$0-2]}];
...
case 2:
		...
		if($$[$0-3]){ 
			for(i in $$[$0-3]){ 
				if($$[$0-3][i].id in symbolsTable){
					symbolsTableProc[$$[$0-3][i].id] = symbolsTable[$$[$0-3][i].id];
					//delete symbolsTable[$$[$0-3][i].id]
					symbolsTableProc[$$[$0-3][i].id].type = "CONST";
					tabla = 1;
				};
				/*else Error */
			};
		...
		if($$[$0-2]){ 
			for(i in $$[$0-2]){ 
				if($$[$0-2][i].value in symbolsTable){
					symbolsTableProc[$$[$0-2][i].value] = symbolsTable[$$[$0-2][i].value];
					//delete symbolsTable[$$[$0-2][i].value]
					symbolsTableProc[$$[$0-2][i].value].type = "VAR";
					symbolsTableProc[$$[$0-2][i].value].value = $$[$0-2][i].value;
					tabla = 1;
				};
				/*else Error */
			};
...
tabla = 1;
		...
		if($$[$0])
		  this.$ = this.$.concat($$[$0]);
		if(tabla != 0) this.$ = this.$.concat([{tabla: symbolsTableProc}]);
...
break;
case 18:
            symbolsTable[$$[$0-2]] = {type: "constvar", value: ""}
	    this.$ = {type: $$[$0-1], left: $$[$0-2], right: $$[$0]};
	  
break;
case 19:
	    symbolsTable[$$[$0-1]] = {type: "PROCEDURE", value: JSON.stringify($$[$0].length)}
